...
#SEIR model: Susceptible -> Infected -> Recovered / Dead
class seir():
    ...
    def spread_virus(self, i):
        ...
        if self.day % self.serial_interval == 0 and self.exposed_before < 4500:
            self.num_new_infected = round(self.beta * self.total_num_infected)
    ...
    def assign_symptoms(self):
        ...
        percent_severe_recovery = 1 - (self.mu / self.percent_severe)
